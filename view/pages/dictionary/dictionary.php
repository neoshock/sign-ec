<div class="row justify-content-center pt-100">
    <div class="col-6">
        ...
        <div class="input-group">
            ...
            <input type="text" id="lds_search_word" class="form-control" placeholder="Escribe una palabra">
        </div>
        <ul class="list-group result-search-word">
            <!--<li class="list-group-item">Uno</li>-->
        </ul>

        <div class="card mb-3 hide" style="margin-top: 10px">
            <div class="row g-0">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    ...
                    <button class="btn btn-success">Ver video</button>
                    </div>
                </div>
            </div>
        </div>
